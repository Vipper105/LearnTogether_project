	...
	<div id="popupContact">
		<form:form modelAttribute="form">
			<img id="close" src="<%=contextPath%>/resources/images/close.jpg"
				onclick="edit_hide()">
			<form:input path="id" id="idTest" required="required"
			...
			<div class="form-group">
				...
				<form:input path="section.id" id="section" required="required" class="form-control"/>
			</div>
			...
			<div class="form-group">
				...
				<form:input path="testtype.id" id="typetest" required="required" class="form-control"/>
			</div>
			<div class="form-group">
		<%-- 		<button class="btn btn-warning"
					formaction="<%=contextPath%>/admin/test/update">Save</button> --%>
