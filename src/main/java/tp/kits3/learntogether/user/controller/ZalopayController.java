...
import tp.kits3.learntogether.user.vo.HMACUtil;

public class ZalopayController {
	@SuppressWarnings({ "serial", "unused" })
	private static HashMap<String, String> config1 = new HashMap<String, String>(){{
        put("appid", "553");
	...
	public static void main( String[] args ) throws Exception
    {
        ...
        order.put("mac", HMACUtil.HMacHexStringEncode(HMACUtil.HMACSHA256, config1.get("key1"), data));

        CloseableHttpClient client = HttpClients.createDefault();
        HttpPost post = new HttpPost(config1.get("endpoint"));
