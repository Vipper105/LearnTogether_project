		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xl-10 col-lg-10">
					<div class="content">
						<div class="row top">
							<h3 class="col-xl-10 col-lg-10">Course table</h3>
					...
					<jsp:include page="../form_view/_user.jsp" />
					</div>
				</div>
			</div>
		</div>
		...
		var id = $(this).parent().find('#id').val();
			$.ajax({
				...
				success : function(data) {
					...
					$("#courseLevel").val(data.courseLevel.levelName);
					$("#numstudent").val(data.numstudent);
					$("#createdate").val(data.createdate);
					$("#lasteupdate").val(data.lasteupdate);
					$("#instructor").val(data.instructor.user.email);
					$("#category").val(data.category.categoryName);	
