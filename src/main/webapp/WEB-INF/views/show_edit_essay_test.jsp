...
<body>
	<%
		Instructor instructor = (Instructor) request.getAttribute("instructor-essay-test");
	%>
	...
	<section>
		...
		<div class="section-container">
			<h1 class="edit-title"><span style="font-size: 25px;margin-right: 3px;">&#128221;</span>Edit essay test</h1>
			<%
					...
					<div>
						...
						%>
							...
							<div>
								...
								<h3><a class="test-title" href="<%=contextPath %>/instructor/edit-essay-test/<%=listTest.get(testIndex).getId() %>/">+ <%=listTest.get(testIndex).getTitle() %></a></h3>				
