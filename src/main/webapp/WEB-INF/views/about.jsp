...
<body>
	...
	<main style="margin-bottom: 50px">
		...
		<!--? About Area-1 Start -->
		<section class="about-area1 fix pt-10" style="margin-top: 40px; margin-bottom: 120px">
			<div class="support-wrapper align-items-center">
				<div class="left-content1 wow slideInLeft">
					...
					<div class="section-tittle section-tittle2 mb-55">
						<div class="front-text">
							...
							<p>We will work on free online learning app covering all areas (IT&amp;Software, Design, Business, marketing ...). The goal is to meet the learning needs at any time, anywhere, especially those who are working can study at any spare time.</p>
						</div>
					</div>
					<div class="single-features">
						...
						<div class="features-caption">
							<p>Techniques to engage effectively with vulnerable children
								and young people.</p>
						</div>
					</div>
					<div class="single-features">
						...
						<div class="features-caption">
							<p>Join millions of people from around the world learning
								together.</p>
						</div>
					</div>
				...
				<div class="right-content1 wow slideInRight">
					<!-- img -->
					<div class="right-img">
		...
		<!-- top subjects End -->
		<!--? About Area-3 Start -->
		<section class="about-area3 fix" style="margin-top: 120px; margin-bottom: 50px">
			<div class="support-wrapper align-items-center">
				<div class="right-content3">
					<!-- img -->
					<div class="right-img wow slideInLeft">
						<img src="resources/assets/img/gallery/Study-Group-web.jpeg" alt="" style="width: 75%; margin-left: 100px;    border-radius: 20px 120px 20px 120px;">
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="team-active">
					...
					<div class="single-cat text-center">
						<div class="cat-icon">
							<img
								src="resources/assets/img/gallery/photo-1-1573635284176282989283.gif"
								alt="">
						</div>
						<div class="cat-cap">
							<h5>
					...
					<div class="single-cat text-center">
						<div class="cat-icon" >
							<img src="resources/assets/img/gallery/huy1.gif" alt="" >
					...
					<div class="single-cat text-center">
						<div class="cat-icon">
							<img src="resources/assets/img/gallery/pho.gif" alt="">
						</div>
						<div class="cat-cap">
							<h5>
