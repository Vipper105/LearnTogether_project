...
<body>
	...
	<div class="container-result">
		...
		<p style="font-size: 19px;">We sent this test to instructor. Score will be sent back soon</p>
		...
		<div id="show-his-test-essay">
			
		</div>
	</div>

	<script>
		var output = document.getElementById('show-his-test-essay');

		function displayHistoryTest() {

			var xhr = new XMLHttpRequest();
			var url = 'show-history-essay';
		...
		function displayShowHide(){
			var x = document.getElementById("show-his-test-essay");
